...
void solve(LinkedList<int>& array1, LinkedList<int>& array2, LinkedList<int>& target) {

    while (!array1.is_empty() && !array2.is_empty())
    {
        if (array1.get(0) < array2.get(0))
        {
            target.push_back(array1.get(0));
            array1.pop_front();
        }
        else
        {
            target.push_back(array2.get(0));
            array2.pop_front();
        }
    }

    while (!array1.is_empty())
    {
        target.push_back(array1.get(0));
        array1.pop_front();
    }
    
    while (!array2.is_empty())
    {
        target.push_back(array2.get(0));
        array2.pop_front();
    }
